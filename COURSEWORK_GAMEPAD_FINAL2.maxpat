...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1055.75, 710.0, 55.0, 22.0 ],
					"text" : "r ybutton"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1127.0, 788.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.500002264976501, 442.666678905487061, 49.0, 22.0 ],
					"text" : "s select"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 614.0, 1120.0, 56.0, 22.0 ],
					"text" : "r dpadup"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 543.666666666666742, 1529.0, 71.0, 22.0 ],
					"text" : "r dpaddown"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 942.0, 928.0, 66.0, 22.0 ],
					"text" : "r dpadright"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 557.0, 1584.0, 59.0, 22.0 ],
					"text" : "r dpadleft"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2046.5, 1132.0, 47.0, 20.0 ],
					"text" : "hihat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1296.25, 195.000005602836609, 29.5, 22.0 ],
					"text" : "-"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1337.0, 195.000005602836609, 29.5, 22.0 ],
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1470.0, 145.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1461.0, 196.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1415.0, 167.0, 30.0, 22.0 ],
					"text" : "* 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1119.0, 1623.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 693.0, 550.0, 70.0, 20.0 ],
					"text" : "SAMPLE 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1279.0, 1583.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 617.0, 550.0, 70.0, 20.0 ],
					"text" : "SAMPLE 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1119.0, 1589.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 543.0, 550.0, 70.0, 20.0 ],
					"text" : "SAMPLE 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 711.0, 584.0, 34.5, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 561.0, 584.0, 34.5, 32.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1884.0, 1234.0, 130.5, 99.833327621221542 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1731.0, 1201.0, 63.0, 22.0 ],
					"text" : "readfolder"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 1767.0, 1249.0, 92.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1838.0, 1194.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2272.083389282226562, 330.0, 50.0, 22.0 ],
					"text" : "s seqs2"
				}
...
,
					"patching_rect" : [ 2073.583389282226562, 472.0, 92.5, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 2050.0, 79.0, 92.5, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1316.5, 145.0, 50.0, 22.0 ],
					"text" : "select 1"
				}
